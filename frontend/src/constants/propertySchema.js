...
export const PROPERTY_FIELDS = [
  ...
  },
  {
    ...
    section: PROPERTY_SECTIONS.ADDITIONAL,
    showIn: { create: true, edit: true, view: true, search: true },
    placeholder: 'e.g., 6.5% or 0.065',
    helperText: 'Enter as percentage (e.g., 6.5%) or decimal (0.065)',
  },
  {
    name: 'property_type',
    label: 'Property Type',
  ...
  },
  {
    ...
    section: PROPERTY_SECTIONS.DETAILS,
    showIn: { create: true, edit: true, view: true, search: true },
    placeholder: 'e.g., Class A, Mixed-use retail, etc.'
  },
  {
    name: 'square_feet',
    label: 'Square Feet',
  ...
  },
  {
    ...
    section: PROPERTY_SECTIONS.DETAILS,
    showIn: { create: true, edit: true, view: true, search: true },
    helperText: 'Computed from Price and Square Feet',
    ui: { grid: { sm: 4 } },
  },
  {
    name: 'acre',
